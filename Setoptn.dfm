object SOptForm1: TSOptForm1
  Left = 532
  Top = 290
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3627#3633#3626#3586#3629#3591#3649#3606#3617
  ClientHeight = 228
  ClientWidth = 446
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object dxStatusBar1: TdxStatusBar
      ...
      Panels = <
        ...
        item
          PanelStyleClassName = 'TdxStatusBarTextPanelStyle'
          Text = #3585#3635#3627#3609#3604#3619#3627#3633#3626#3586#3629#3591#3649#3606#3617
          Width = 120
        end
        item
          PanelStyleClassName = 'TdxStatusBarTextPanelStyle'
          Text = 'HOPTMAST,OPTMAST'
          Width = 150
        end
        item
          PanelStyleClassName = 'TdxStatusBarTextPanelStyle'
  ...
  object QOptmas: TFDQuery
    AfterPost = QOptmasAfterPost
    AfterCancel = QOptmasAfterCancel
    BeforeDelete = QOptmasBeforeDelete
    AfterDelete = QOptmasAfterPost
    OnNewRecord = QOptmasNewRecord
    CachedUpdates = True
    ConnectionName = 'HI_DBMS'
    UpdateOptions.AssignedValues = [uvUpdateMode]
    UpdateOptions.UpdateMode = upWhereChanged
    SQL.Strings = (
      'SELECT * FROM  HOPTMAST')
    Left = 272
    Top = 74
    object QOptmasOPTCODE: TStringField
      FieldName = 'OPTCODE'
      FixedChar = True
      Size = 18
    end
    object QOptmasOPTNAME: TStringField
      FieldName = 'OPTNAME'
      FixedChar = True
      Size = 60
    end
    object QOptmasUNITPRC: TFloatField
      FieldName = 'UNITPRC'
    end
    object QOptmasUNITCST: TFloatField
      FieldName = 'UNITCST'
    end
  end
  object qrOptTran: TFDQuery
    MasterSource = DataSource1
    MasterFields = 'OPTCODE'
    ConnectionName = 'HI_DBMS'
    SQL.Strings = (
      'SELECT * FROM  OPTMAST WHERE OPTCODE=:OPTCODE')
    Left = 372
    Top = 68
    ParamData = <
      item
    ...
    object qrOptTranOPTCODE: TStringField
      DisplayWidth = 18
      FieldName = 'OPTCODE'
      FixedChar = True
      Size = 18
    end
    object qrOptTranLOCAT: TStringField
      DisplayWidth = 6
      FieldName = 'LOCAT'
      FixedChar = True
      Size = 5
    end
    object qrOptTranOPTNAME: TStringField
      DisplayWidth = 60
      FieldName = 'OPTNAME'
      FixedChar = True
      Size = 60
    end
    object qrOptTranUNITPRC: TFloatField
      DisplayWidth = 10
      FieldName = 'UNITPRC'
      DisplayFormat = '##,##0.00'
    end
    object qrOptTranUNITCST: TFloatField
      DisplayWidth = 10
      FieldName = 'UNITCST'
      DisplayFormat = '##,##0.00'
    end
    object qrOptTranONHAND: TFloatField
      DisplayWidth = 10
      FieldName = 'ONHAND'
    end
  end
