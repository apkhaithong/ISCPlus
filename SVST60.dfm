object SvSt_60: TSvSt_60
  Left = 588
  Top = 200
  BorderStyle = bsDialog
  Caption = #3585#3635#3627#3609#3604#3649#3615#3657#3617#3605#3619#3623#3592#3648#3594#3655#3588#3605#3634#3617#3619#3632#3618#3632
  ClientHeight = 455
  ClientWidth = 557
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Width = 79
    Height = 13
    Caption = #3619#3627#3633#3626#3585#3621#3640#3656#3617#3648#3594#3655#3588#3619#3632#3618#3632
    Font.Charset = THAI_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Tahoma'
  ...
  object DBGrid1: TRzDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'SVCODE'
        Title.Caption = #3619#3627#3633#3626#3605#3619#3623#3592#3648#3594#3655#3588
        Width = 97
        Visible = True
      end
      item
        ...
        Title.Caption = #3619#3634#3618#3621#3632#3648#3629#3637#3618#3604#3585#3634#3619#3605#3619#3623#3592#3648#3594#3655#3588
        Width = 366
        Visible = True
      end>
  end
  object DBEdit1: TcxDBTextEdit
    ...
    DataBinding.DataSource = dsModelmst
  ...
  object QCheckList: TFDQuery
    OnNewRecord = QCheckListNewRecord
    CachedUpdates = True
    ConnectionName = 'HI_DBMS'
    UpdateOptions.AssignedValues = [uvUpdateMode]
    SQL.Strings = (
