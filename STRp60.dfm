object FmSTRp60: TFmSTRp60
  ...
  object AdvPanel1: TAdvPanel
    ...
    object Label10: TLabel
      ...
      Caption = #3592#3634#3585#3623#3633#3609#3607#3637#3656#3648#3610#3636#3585' :'
      Font.Charset = THAI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
    ...
    object CheckBox2: TcxCheckBox
      Left = 99
      Top = 112
      Caption = #3648#3593#3614#3634#3632#3619#3634#3618#3585#3634#3619#3607#3637#3656#3618#3633#3591#3652#3617#3656#3629#3629#3585#3651#3610#3585#3635#3585#3633#3610#3651#3609#3594#3656#3623#3591#3623#3633#3609#3607#3637#3656#3619#3632#3610#3640
      ParentFont = False
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
    ...
    object CheckBox1: TcxCheckBox
      Left = 99
      Top = 134
      Caption = #3648#3593#3614#3634#3632#3619#3634#3618#3585#3634#3619#3607#3637#3656#3619#3634#3588#3634#3586#3634#3618#3626#3640#3607#3608#3636#3605#3656#3635#3585#3623#3656#3634#3607#3640#3609#3648#3593#3621#3637#3656#3618
      ParentFont = False
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
    ...
    object RadioGp1: TAdvOfficeRadioGroup
      ...
      ItemIndex = 0
      Items.Strings = (
        #3648#3610#3636#3585#3648#3614#3639#3656#3629#3612#3621#3636#3605
        #3648#3610#3636#3585#3648#3614#3639#3656#3629#3626#3656#3591#3648#3626#3619#3636#3617#3585#3634#3619#3586#3634#3618
        #3648#3610#3636#3585#3648#3614#3639#3656#3629' NCR'
        #3648#3648#3610#3636#3585#3648#3614#3639#3656#3629' LAB R & D'
        #3648#3610#3636#3585#3648#3614#3639#3656#3629#3592#3633#3604#3594#3640#3604#3626#3636#3609#3588#3657#3634
        #3619#3623#3617#3607#3633#3657#3591#3627#3617#3604)
      Ellipsis = False
    end
    object RadioGroup1: TAdvOfficeRadioGroup
      ...
      Items.Strings = (
        ...
        #3648#3610#3636#3585#3616#3634#3618#3651#3609
    ...
    object RadioGp2: TAdvOfficeRadioGroup
      ...
      ItemIndex = 0
      Items.Strings = (
        #3648#3621#3586#3607#3637#3656#3651#3610#3648#3610#3636#3585
        #3623#3633#3609#3607#3637#3656#3651#3610#3648#3610#3636#3585)
      Ellipsis = False
    end
  end
  ...
  object qrSalePart: TFDQuery
    ConnectionName = 'HI_DBMS'
    SQL.Strings = (
      
        'SELECT A.Pkno,A.PkLocat,A.REFNO,A.REFDAT,A.PkDate,A.PartNo,A.Upr' +
        'ice,(A.QtyOut*A.Uprice) As Total,'
      
        '              (A.QtyOut*A.Uprice-A.Totprc) As Redu1,(A.Avgcost*A' +
        '.Qtyout) As Cost,C.type,C.Model, '
      
        '              A.Jobno, A.QtyOut,A.NetPrc,A.Totprc AS Totprc,A.Fl' +
        'ag,B.Cuscod,B.Officcod ,C.Group1 '
      '              From Pk_Trans A,Pk_Invoi B,Inventor C '
      
        '              Where (A.PKNO=B.PKNO) And (A.Pklocat=C.Locat) and ' +
        '(A.Partno=C.Partno)'
      '               Order by PKNO')
    Left = 444
    Top = 66
    object qrSalePartPKLOCAT: TStringField
      DisplayLabel = #3626#3634#3586#3634
      FieldName = 'PKLOCAT'
      FixedChar = True
      Size = 5
    end
    object qrSalePartPKDATE: TDateField
      DisplayLabel = #3623#3633#3609#3607#3637#3656
      FieldName = 'PKDATE'
    end
    object qrSalePartPKNO: TStringField
      DisplayLabel = #3648#3621#3586#3651#3610#3648#3610#3636#3585
      FieldName = 'PKNO'
      FixedChar = True
      Size = 12
    end
    object qrSalePartGROUP1: TStringField
      DisplayLabel = #3585#3621#3640#3656#3617#3626#3636#3609#3588#3657#3634
      FieldName = 'GROUP1'
      FixedChar = True
      Size = 5
    end
    object qrSalePartPARTNO: TStringField
      DisplayLabel = #3648#3610#3629#3619#3660#3629#3632#3652#3627#3621#3656
      FieldName = 'PARTNO'
      FixedChar = True
    end
    object qrSalePartTOTPRC: TFloatField
      DisplayLabel = #3619#3634#3588#3634#3586#3634#3618
      FieldName = 'TOTPRC'
      DisplayFormat = '##,##0.00'
    end
    object qrSalePartCOST: TFloatField
      DisplayLabel = #3605#3657#3609#3607#3640#3609
      FieldName = 'COST'
      DisplayFormat = '##,##0.00'
    end
    object qrSalePartTYPE: TStringField
      DisplayLabel = #3618#3637#3656#3627#3657#3629
      FieldName = 'TYPE'
      FixedChar = True
      Size = 5
    end
    object qrSalePartMODEL: TStringField
      DisplayLabel = #3619#3640#3656#3609
      FieldName = 'MODEL'
      FixedChar = True
    end
    object qrSalePartJOBNO: TStringField
      DisplayLabel = #3648#3621#3586' JOB'
      FieldName = 'JOBNO'
      FixedChar = True
      Size = 15
    end
