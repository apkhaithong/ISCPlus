object FrPriceList: TFrPriceList
  Left = 356
  Top = 122
  ...
  object edPart: TcxButtonEdit
    ...
    Properties.OnButtonClick = edPartPropertiesButtonClick
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      object cxGrid1DBTableView1DESCP: TcxGridDBColumn
  ...
  object qPriceList: TFDQuery
    ConnectionName = 'Hi_dbms'
    SQL.Strings = (
      'SELECT * FROM INVMAST')
    Left = 28
    Top = 184
    object qPriceListPARTNO: TStringField
      FieldName = 'PARTNO'
      FixedChar = True
    end
    object qPriceListDESC1: TStringField
      FieldName = 'DESC1'
      FixedChar = True
      Size = 45
    end
    object qPriceListUNIT: TStringField
      FieldName = 'UNIT'
      FixedChar = True
      Size = 10
    end
    object qPriceListCOST: TFloatField
      FieldName = 'COST'
      DisplayFormat = '##,##0.00'
    end
    object qPriceListPRICE1: TFloatField
      FieldName = 'PRICE1'
      DisplayFormat = '##,##0.00'
    end
    object qPriceListPRICE2: TFloatField
      FieldName = 'PRICE2'
      DisplayFormat = '##,##0.00'
    end
    object qPriceListPRICE3: TFloatField
      FieldName = 'PRICE3'
      DisplayFormat = '##,##0.00'
    end
    object qPriceListPRICE4: TFloatField
      FieldName = 'PRICE4'
      DisplayFormat = '##,##0.00'
    end
    object qPriceListNETPRC: TStringField
      FieldName = 'NETPRC'
      FixedChar = True
      Size = 1
    end
    object qPriceListGROUP1: TStringField
      FieldName = 'GROUP1'
      FixedChar = True
      Size = 5
    end
