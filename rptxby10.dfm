object FRpTxBy10: TFRpTxBy10
  Left = 397
  Top = 267
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3634#3618#3591#3634#3609#3616#3634#3625#3637#3595#3639#3657#3629'-'#3619#3606
  ClientHeight = 278
  ClientWidth = 436
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object RadioGroup2: TAdvOfficeRadioGroup
      ...
      ItemIndex = 1
      Items.Strings = (
        #3616#3634#3625#3637#3595#3639#3657#3629#3607#3633#3657#3591#3627#3617#3604
  ...
  object Query1: TFDQuery
    ...
    SQL.Strings = (
      'select t.locat,t.taxno,t.taxdate,t.cuscod,t.desc1,'
      
        '       t.vatrt,t.balance,t.vat,t.tottax,t.flag,a.apname,X.STRNO,' +
        'X.NETCOST,X.CRVAT,X.TOTCOST'
      
        'FROM TAXBUY T LEFT JOIN TAXBUYTRN X ON (T.TAXNO=X.TAXNO),APMAST ' +
        'A WHERE T.CUSCOD=A.APCODE')
    Left = 336
    Top = 16
    object Query1LOCAT: TStringField
    ...
    object Query1TOTTAX: TFloatField
    ...
    object Query1CUSCOD: TStringField
      FieldName = 'CUSCOD'
      FixedChar = True
      Size = 12
    end
    object Query1VATRT: TFloatField
      FieldName = 'VATRT'
    end
