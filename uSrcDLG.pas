...
type
  TfSrcDLG = class(TForm)
    ...
    procedure DBGrid1DBTableView1CustomDrawIndicatorCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxCustomGridIndicatorItemViewInfo; var ADone: Boolean);
    ...
    procedure DBGrid1DBTableView1DataControllerGroupingChanged(Sender: TObject);
  private
...
begin
  if qrFindDat.Active then
    case OrderCombo.Tag of
      0:
        Result := qrFindDat.Fieldbyname('PARTNO').Asstring;
      1:
        Result := qrFindDat.Fieldbyname('LOCATCD').Asstring;
      2:
        Result := qrFindDat.Fieldbyname('GROUPCOD').Asstring;
      3:
        Result := qrFindDat.Fieldbyname('TYPECOD').Asstring;
      4:
        Result := qrFindDat.Fieldbyname('APCODE').Asstring;
      5:
        Result := qrFindDat.Fieldbyname('CUSCOD').Asstring;
      6:
        Result := qrFindDat.Fieldbyname('PAYCODE').Asstring;
      7:
        Result := qrFindDat.Fieldbyname('CODE').Asstring;
      8:
        Result := qrFindDat.Fieldbyname('PONO').Asstring;
      9:
        Result := qrFindDat.Fieldbyname('JOBNO').Asstring;
      10:
        Result := qrFindDat.Fieldbyname('PKNO').Asstring;
      11:
        Result := qrFindDat.Fieldbyname('ORDNO').Asstring;
      12:
        Result := qrFindDat.Fieldbyname('PARTNO').Asstring;
      13:
        Result := qrFindDat.Fieldbyname('BANKCOD').Asstring;
      14:
        Result := qrFindDat.Fieldbyname('MODELCOD').Asstring;
      15:
        Result := qrFindDat.Fieldbyname('TAXNO').Asstring;
      16:
        Result := qrFindDat.Fieldbyname('RECVNO').Asstring;
      17:
        Result := qrFindDat.Fieldbyname('SLCODE').Asstring;
      18:
        Result := qrFindDat.Fieldbyname('ARGCOD').Asstring;
      19:
        Result := qrFindDat.Fieldbyname('OTHIVNO').Asstring;
      20:
        Result := qrFindDat.Fieldbyname('QUOTNO').Asstring;
      21:
        Result := qrFindDat.Fieldbyname('ADJNO').Asstring;
      22:
        Result := qrFindDat.Fieldbyname('PartNo').Asstring;
      23:
        Result := qrFindDat.Fieldbyname('INVNO').Asstring;
      24:
        Result := qrFindDat.Fieldbyname('RTNNO').Asstring;
      25:
        Result := qrFindDat.Fieldbyname('MOVNO').Asstring;
      26:
        Result := qrFindDat.Fieldbyname('RECVNO').Asstring;
      27:
        Result := qrFindDat.Fieldbyname('QANO').Asstring;
      28:
        Result := qrFindDat.Fieldbyname('ADJNO').Asstring;
      29:
        Result := qrFindDat.Fieldbyname('JOBNO').Asstring;
      30:
        Result := qrFindDat.Fieldbyname('Campno').Asstring;
      31:
        Result := qrFindDat.Fieldbyname('Kitcode').Asstring;
      32:
        Result := qrFindDat.Fieldbyname('CHQNO').Asstring;
      33:
        Result := qrFindDat.Fieldbyname('STRNO').Asstring;
      34:
        Result := qrFindDat.Fieldbyname('CODE').Asstring;
      35:
        Result := qrFindDat.Fieldbyname('APCODE').Asstring;
      ...
      37:
        Result := qrFindDat.Fieldbyname('PARTNO').Asstring;
      38:
        Result := qrFindDat.Fieldbyname('BARCODE').Asstring;
      39:
        Result := qrFindDat.Fieldbyname('BANKBOOKCOD').Asstring;
      40:
        Result := qrFindDat.Fieldbyname('INVNO').Asstring;
      41:
        Result := qrFindDat.Fieldbyname('TAXNO').Asstring;
      ...
      47:
        Result := qrFindDat.Fieldbyname('INVNO').Asstring;
      48:
        Result := qrFindDat.Fieldbyname('SUBCODE').Asstring;
      49:
        Result := qrFindDat.Fieldbyname('DOCNO').Asstring;
      50:
        Result := qrFindDat.Fieldbyname('DOCNO').Asstring;
      51:
        Result := qrFindDat.Fieldbyname('JOBNO').Asstring;
      ...
      53:
        Result := qrfindDat.fieldbyname('DOCNO').AsString;
      54:
        Result := qrfindDat.fieldbyname('PROCODE').AsString;
      55:
        Result := qrfindDat.fieldbyname('QNO').AsString;
      56:
        Result := qrFindDat.Fieldbyname('PARTNO').Asstring;
    end;
end;
...
//        If Not qrFindDat.Prepared Then qrFindDat.Prepare;
      ...
      46:
        begin
          ...
          qrFindDat.Params[0].Asstring := Uppercase('%' + SearchEd.Text + '%');
          if OrderCombo.Itemindex <> 3 then
            qrFindDat.Params[1].Asstring := XSrLocat + '%'
          else
            qrFindDat.Params[1].Asstring := XSrLocat + '%';
...
procedure TfSrcDLG.DBGrid1DBTableView1CustomDrawIndicatorCell(Sender: TcxGridTableView; ACanvas: TcxCanvas; AViewInfo: TcxCustomGridIndicatorItemViewInfo; var ADone: Boolean);
var
...
procedure TfSrcDLG.DBGrid1DBTableView1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    OKBtn.Click;
...
begin
  if cxCheckBox1.Checked = true then
    DBGrid1DBTableView1.DataController.Groups.FullExpand
  else
    DBGrid1DBTableView1.DataController.Groups.FullCollapse;
end;

procedure TfSrcDLG.DBGrid1DBTableView1DataControllerGroupingChanged(Sender: TObject);
begin
