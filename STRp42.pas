...
procedure TFmSTRp42.FormCreate(Sender: TObject);
Var ed1,Ed3,Ed4,Onlo,Onhn,Opt: String;
    xmon,L1 :word;
begin
   Condpay.Open;
   ...
   begin
      ...
      Sql.Add('SELECT LOC,PARTNO,STKDATE,QTYIN,ABS(QTYOUT) AS QTYOUT,PKNO,TAXNO, '+
              ...
              '(Taxdate>=:edit1 and Taxdate<=:edit2) ORDER BY TAXDATE,TIME1');
   ...
   begin
     Close;
     SQL.Clear;
     SQL.ADD('SELECT ia.'+Onhn+' as qty1,im.desc1 '+
...
procedure TFmSTRp42.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   Action := Cafree;
end;


procedure TFmSTRp42.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   sum1 := Query92.fieldbyname('Qty1').AsFloat;
end;

procedure TFmSTRp42.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
   QRLabel21.Caption := Floattostr(sum1);
end;

procedure TFmSTRp42.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
