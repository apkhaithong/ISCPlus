object FQuerySale: TFQuerySale
  Left = 468
  Top = 179
  Caption = #3626#3629#3610#3606#3634#3617#3619#3634#3618#3621#3632#3648#3629#3637#3618#3604#3585#3634#3619#3586#3634#3618
  ClientHeight = 579
  ClientWidth = 1030
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object cxComboBox1: TcxComboBox
      ...
      Properties.Items.Strings = (
        ...
        '15'
        '20')
      Properties.OnChange = EnqBtnClick
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
      Style.Font.Name = 'Tahoma'
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          Format = '##,##0.00'
          Kind = skSum
          Column = cxGrid1DBTableView1REDU1
        end
        item
          Format = '##,##0.00'
          Kind = skSum
      ...
      object cxGrid1DBTableView1INVLOC: TcxGridDBColumn
        Caption = #3626#3634#3586#3634
        DataBinding.FieldName = 'INVLOC'
        HeaderAlignmentHorz = taCenter
      end
      object cxGrid1DBTableView1INVNO: TcxGridDBColumn
        Caption = #3648#3621#3586#3607#3637#3656#3629#3657#3634#3591#3629#3636#3591
        DataBinding.FieldName = 'INVNO'
        HeaderAlignmentHorz = taCenter
      end
      object cxGrid1DBTableView1INVDATE: TcxGridDBColumn
      ...
      object cxGrid1DBTableView1REDU1: TcxGridDBColumn
    ...
    object cxGrid1DBTableView2: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          Format = '##,##0.00'
          Kind = skSum
          Column = cxGrid1DBTableView2TOTPRC
        end>
      DataController.Summary.SummaryGroups = <>
      OptionsBehavior.CellHints = True
      OptionsBehavior.FocusCellOnTab = True
      ...
      OptionsView.Indicator = True
      Styles.ContentOdd = SFMain.cxStyle4
      object cxGrid1DBTableView2PARTNO: TcxGridDBColumn
        Caption = #3619#3627#3633#3626#3626#3636#3609#3588#3657#3634
        DataBinding.FieldName = 'PARTNO'
        HeaderAlignmentHorz = taCenter
      end
      object cxGrid1DBTableView2DESC1: TcxGridDBColumn
        Caption = #3619#3634#3618#3621#3632#3648#3629#3637#3618#3604#3626#3636#3609#3588#3657#3634
        DataBinding.FieldName = 'DESC1'
        HeaderAlignmentHorz = taCenter
      end
      object cxGrid1DBTableView2QTYOUT: TcxGridDBColumn
        Caption = #3592#3635#3609#3623#3609
        DataBinding.FieldName = 'QTYOUT'
        HeaderAlignmentHorz = taCenter
        Width = 52
      end
      object cxGrid1DBTableView2TOTPRC: TcxGridDBColumn
    ...
    object cxGrid1DBChartView1: TcxGridDBChartView
      Categories.DataBinding.FieldName = 'DESC1'
      DataController.DataSource = DataSource2
      ...
      Styles.ToolBox = SFMain.cxStyle4
      Title.Text = 'Product top Sales'
      ToolBox.CustomizeButton = True
      ToolBox.DiagramSelector = True
      object cxGrid1DBChartView1Series1: TcxGridDBChartSeries
        DataBinding.FieldName = 'TOTPRC'
        DisplayText = 'Product top Sales'
        SortOrder = soDescending
        ValueCaptionFormat = #3647',0'
      end
    end
    ...
    object cxGrid1Level2: TcxGridLevel
      Caption = 'Product top sale'
      GridView = cxGrid1DBTableView2
    end
    object cxGrid1Level3: TcxGridLevel
      Caption = 'Product top chart'
  ...
  object qrPkNoTax: TFDQuery
    ...
    SQL.Strings = (
        ...
        '(C.SNAM)||RTRIM(C.NAME1)||'#39'  '#39'||RTRIM(C.NAME2),1,40) CUSTNAME,'
      '      B.TAXNO,B.TAXDATE,B.PKNO,A.QTYOUT,'
      
        '      A.UPRICE,(A.QTYOUT*A.UPRICE-A.TOTPRC) AS REDU1,A.TOTPRC,A.' +
        'GROUP1 '
      'FROM IC_TRANS A,IC_INVOI B,CUSTMAST C'
      
        '      WHERE (B.CUSCOD=C.CUSCOD) AND (A.INVNO=B.INVNO) AND A.INVL' +
        'OC LIKE '#39'%'#39' AND (A.PARTNO LIKE '#39'%'#39' ) AND B.CANCELID IS NULL AND'
      
        '      A.INVDATE>='#39'2012-04-01'#39'  AND A.INVDATE<='#39'2012-04-06'#39' AND A' +
        '.CUSCOD LIKE '#39'%'#39'  AND A.GROUP1 LIKE '#39'%'#39'  AND B.FLAG<>'#39'T'#39
      'ORDER BY A.INVLOC,A.CUSCOD,A.INVDATE,A.PARTNO')
    Left = 37
    Top = 228
    object qrPkNoTaxINVLOC: TStringField
      FieldName = 'INVLOC'
      ReadOnly = True
      FixedChar = True
      Size = 5
    end
    object qrPkNoTaxPARTNO: TStringField
      FieldName = 'PARTNO'
      ReadOnly = True
      FixedChar = True
    end
    object qrPkNoTaxINVNO: TStringField
      FieldName = 'INVNO'
      ReadOnly = True
      FixedChar = True
      Size = 12
    end
    object qrPkNoTaxINVDATE: TDateField
      FieldName = 'INVDATE'
      ReadOnly = True
    end
    object qrPkNoTaxCUSCOD: TStringField
      FieldName = 'CUSCOD'
      ReadOnly = True
      FixedChar = True
      Size = 12
    end
    object qrPkNoTaxCUSTNAME: TStringField
      FieldName = 'CUSTNAME'
      ReadOnly = True
      FixedChar = True
      Size = 40
    end
    object qrPkNoTaxTAXNO: TStringField
      FieldName = 'TAXNO'
      ReadOnly = True
      FixedChar = True
      Size = 12
    end
    object qrPkNoTaxTAXDATE: TDateField
      FieldName = 'TAXDATE'
      ReadOnly = True
    end
    object qrPkNoTaxPKNO: TStringField
      FieldName = 'PKNO'
      ReadOnly = True
      FixedChar = True
      Size = 12
    end
    object qrPkNoTaxQTYOUT: TFloatField
      FieldName = 'QTYOUT'
      ReadOnly = True
    end
    object qrPkNoTaxUPRICE: TFloatField
      FieldName = 'UPRICE'
      ReadOnly = True
      DisplayFormat = '##,##0.00'
    end
    object qrPkNoTaxREDU1: TFloatField
      FieldName = 'REDU1'
      ReadOnly = True
      DisplayFormat = '##,##0.00'
    end
    object qrPkNoTaxTOTPRC: TFloatField
      FieldName = 'TOTPRC'
      ReadOnly = True
      DisplayFormat = '##,##0.00'
    end
    object qrPkNoTaxGROUP1: TStringField
      FieldName = 'GROUP1'
      ReadOnly = True
      FixedChar = True
      Size = 5
  ...
  object Query2: TFDQuery
    ...
    SQL.Strings = (
        ...
        'ALANCE,A.VATAMT,A.FLAG, '
      
        '    B.NAME1,B.NAME2  FROM PK_INVOI A,ARMAST B WHERE A.CUSCOD=B.C' +
        'USCOD')
    Left = 376
    Top = 216
  end
  ...
  object qrTopsale1: TFDQuery
    ...
    SQL.Strings = (
        ...
        'C'
      'FROM IC_TRANS A,INVMAST T,IC_INVOI B'
      
        '      WHERE (A.PARTNO=T.PARTNO) AND (A.INVNO=B.INVNO) AND A.INVL' +
        'OC LIKE '#39'%'#39' AND (A.PARTNO LIKE '#39'%'#39' ) AND B.CANCELID IS NULL AND'
      
        '      A.INVDATE>='#39'2012-04-01'#39'  AND A.INVDATE<='#39'2012-04-06'#39' AND A' +
        '.CUSCOD LIKE '#39'%'#39'  AND A.GROUP1 LIKE '#39'%'#39'  AND B.FLAG<>'#39'T'#39
      'GROUP BY A.PARTNO,T.DESC1'
      'ORDER BY A.PARTNO desc'
    ...
    object qrTopsale1DESC1: TStringField
      FieldName = 'DESC1'
      FixedChar = True
      Size = 45
    end
