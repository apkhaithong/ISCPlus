object FmSvSt92: TFmSvSt92
  Left = 420
  Top = 160
  BorderStyle = bsDialog
  Caption = #3592#3633#3604#3585#3621#3640#3656#3617#3619#3634#3618#3585#3634#3619#3629#3632#3652#3627#3621#3656
  ClientHeight = 555
  ClientWidth = 583
  Color = clBtnFace
  ...
  object DBGrid1: TRzDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'PARTNO'
        Title.Caption = #3619#3627#3633#3626#3629#3632#3652#3627#3621#3656
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'DESC1'
        Title.Caption = #3594#3639#3656#3629#3629#3632#3652#3627#3621#3656
        Visible = True
      end
      item
        Expanded = False
