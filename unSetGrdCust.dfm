object FSetGrdCust: TFSetGrdCust
  Left = 401
  Top = 260
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3648#3585#3619#3604#3621#3641#3585#3588#3657#3634
  ClientHeight = 207
  ClientWidth = 465
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object DBCheckBox1: TcxDBCheckBox
      Left = 131
      Top = 133
      Caption = #3629#3609#3640#3597#3634#3605#3636#3611#3621#3656#3629#3618#3626#3636#3609#3648#3594#3639#3656#3629'/'#3586#3634#3618
      DataBinding.DataField = 'GRDFLG'
      DataBinding.DataSource = DataSource1
      ParentFont = False
    ...
    object dxStatusBar1: TdxStatusBar
      ...
      Panels = <
        ...
        item
          PanelStyleClassName = 'TdxStatusBarTextPanelStyle'
          Text = #3585#3635#3627#3609#3604#3619#3627#3633#3626#3648#3585#3619#3604#3621#3641#3585#3588#3657#3634
          Width = 150
        end
        item
          PanelStyleClassName = 'TdxStatusBarTextPanelStyle'
  ...
  object qrGrdCust: TFDQuery
    AfterPost = qrGrdCustAfterPost
