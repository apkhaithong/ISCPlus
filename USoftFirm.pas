...
begin
  ...
  begin
    ...
    if (Eof and Bof) then
    begin
      SFMain.AdvSmoothMessageDialog2.Caption := 'คุณลงทะเบียนการใช้งานหรือยัง?';
      SFMain.AdvSmoothMessageDialog2.HTMLText.Text := 'ติดต่อขอรหัสลงทะเบียนตามช่องทางดังนี้<br/>1.LINE id. : 0884939537<br/>' +
...
begin
  ...
  begin
    ...
    SFMain.AdvSmoothMessageDialog2.HTMLText.Text := 'ตรวจสอบไฟล์โปรแกรมที่อัพเดทกว่าเครื่องที่คุณกำลังใช้งาน<br/>' +
      ...
      mrOk:
        begin
          ...
          if WinExec(@Command[1], SW_SHOWNORMAL) < 32 then
            SFMain.RaiseException('Error # ไม่สามารถอัพเดทโปรแกรม..!');
        end;
    end;
  end;
end;
