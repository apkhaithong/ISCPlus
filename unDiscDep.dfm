object frDisDep: TfrDisDep
  Left = 410
  Top = 361
  BorderIcons = []
  Caption = #3621#3604#3627#3609#3637#3657#3617#3633#3604#3592#3635#3611#3657#3634#3618#3649#3604#3591
  ClientHeight = 364
  ClientWidth = 556
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object Label1: TLabel
      ...
      Height = 16
      Alignment = taRightJustify
      Caption = #3629#3657#3634#3591#3629#3636#3591#3648#3621#3586#3607#3637#3656#3588#3641#3656#3617#3639#3629' :'
      Font.Charset = THAI_CHARSET
      Font.Color = clBlack
      Font.Height = -13
      Font.Name = 'Tahoma'
    ...
    object Label2: TLabel
      ...
      Height = 16
      Alignment = taRightJustify
      Caption = #3619#3633#3610#3648#3591#3636#3609#3588#3656#3634#3617#3633#3604#3592#3635' :'
      Font.Charset = THAI_CHARSET
      Font.Color = clBlack
      Font.Height = -13
      Font.Name = 'Tahoma'
  ...
  object dxStatusBar1: TdxStatusBar
    ...
    Panels = <
      ...
      item
        PanelStyleClassName = 'TdxStatusBarTextPanelStyle'
        Text = #3610#3633#3609#3607#3638#3585#3621#3604#3627#3609#3637#3657#3648#3591#3636#3609#3617#3633#3604#3592#3635#3611#3657#3634#3618#3649#3604#3591
        Width = 150
      end
      item
        PanelStyleClassName = 'TdxStatusBarTextPanelStyle'
  ...
  object qrStkDepRed: TFDQuery
    AfterPost = qrStkDepRedAfterPost
    AfterDelete = qrStkDepRedAfterDelete
    OnCalcFields = qrStkDepRedCalcFields
    OnNewRecord = qrStkDepRedNewRecord
    CachedUpdates = True
    ConnectionName = 'HI_DBMS'
    SQL.Strings = (
      'SELECT * FROM STKDEPRED')
    Left = 16
    Top = 204
    object qrStkDepRedUpdatestatus: TStringField
      FieldKind = fkCalculated
      FieldName = 'Updatestatus'
      Size = 25
      Calculated = True
    end
    object qrStkDepRedDEPRED: TStringField
      FieldName = 'DEPRED'
      OnChange = qrStkDepRedDEPREDChange
      FixedChar = True
      Size = 12
    end
    object qrStkDepRedLOCAT: TStringField
      FieldName = 'LOCAT'
      OnValidate = qrStkDepRedLOCATValidate
      FixedChar = True
      Size = 5
    end
    object qrStkDepRedDEPDT: TDateField
      FieldName = 'DEPDT'
      OnValidate = qrStkDepRedDEPDTValidate
    end
    object qrStkDepRedREGRED: TStringField
      FieldName = 'REGRED'
      OnChange = qrStkDepRedREGREDChange
      OnValidate = qrStkDepRedREGREDValidate
      FixedChar = True
      Size = 12
    end
    object qrStkDepRedFRONT: TStringField
      FieldName = 'FRONT'
      FixedChar = True
      Size = 1
    end
    object qrStkDepRedHIND: TStringField
      FieldName = 'HIND'
      FixedChar = True
      Size = 1
    end
    object qrStkDepRedBOOK: TStringField
      FieldName = 'BOOK'
      FixedChar = True
      Size = 1
    end
    object qrStkDepRedDEPOSIT: TFloatField
      FieldName = 'DEPOSIT'
      DisplayFormat = '##,##0.00'
    end
    object qrStkDepRedDISCDEP: TFloatField
      FieldName = 'DISCDEP'
      DisplayFormat = '##,##0.00'
    end
    object qrStkDepRedMEMO1: TMemoField
      FieldName = 'MEMO1'
      BlobType = ftMemo
      Size = 512
    end
    object qrStkDepRedUSERID: TStringField
      FieldName = 'USERID'
      FixedChar = True
      Size = 12
    end
    object qrStkDepRedINPDATE: TDateTimeField
      FieldName = 'INPDATE'
    end
    object qrStkDepRedREGNO: TStringField
      FieldName = 'REGNO'
      FixedChar = True
      Size = 12
    end
    object qrStkDepRedSTRNO: TStringField
      FieldName = 'STRNO'
      FixedChar = True
    end
    object qrStkDepRedCUSCOD: TStringField
      FieldName = 'CUSCOD'
      FixedChar = True
      Size = 12
    end
