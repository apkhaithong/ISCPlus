object QRpSv42: TQRpSv42
  ...
  AutoScroll = False
  Caption = #3619#3634#3618#3591#3634#3609' '#3605#3657#3609#3607#3640#3609#3649#3621#3632#3585#3635#3652#3619#3649#3605#3656#3621#3632' JOB'
  Color = clBtnFace
  ...
  object QRep: TQuickRep
    ...
    object PageHeader: TQRBand
      ...
      object QRLabel11: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = #3605#3657#3609#3607#3640#3609#3629#3632#3652#3627#3621#3656
        Color = clWhite
        Font.Charset = THAI_CHARSET
        Font.Color = clBlack
        Font.Height = -16
      ...
      object QRLabel2: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = #3605#3657#3609#3607#3640#3609#3609#3657#3635#3617#3633#3609
        Color = clWhite
        Font.Charset = THAI_CHARSET
        Font.Color = clBlack
        Font.Height = -16
      ...
      object QRLabel14: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = #3605#3657#3609#3607#3640#3609#3591#3634#3609#3626#3637
        Color = clWhite
        Font.Charset = THAI_CHARSET
        Font.Color = clBlack
        Font.Height = -16
      ...
      object QRLabel3: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = #3612#3641#3657#3619#3633#3610#3619#3606
        Color = clWhite
        Font.Charset = THAI_CHARSET
        Font.Color = clBlack
        Font.Height = -16
      ...
      object QRLabel9: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = #3612#3641#3657#3611#3636#3604' JOB'
        Color = clWhite
        Font.Charset = THAI_CHARSET
        Font.Color = clBlack
        Font.Height = -16
      ...
      object QRLabel16: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = #3605#3657#3609#3607#3640#3609#3591#3634#3609#3609#3629#3585
        Color = clWhite
        Font.Charset = THAI_CHARSET
        Font.Color = clBlack
        Font.Height = -16
  ...
  object Query3: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT J.JOBNO,J.RECVDATE,J.REPTYPE,J.PARTCOST,J.RECVCOD,J.PTAXN' +
        'O,J.STATUS,'
      
        '           J.OILCOST,(J.SERVNET+J.OILNET+J.OUTJNET+J.COLORNet+J.' +
        'OTHERNET+J.PARTNET) AS Sum1,'
      '           J.LOCAT,J.STRNO,S.REGNO,J.REPCOD  '
    ...
    object Query3RECVDATE: TDateField
      FieldName = 'RECVDATE'

    end
    object Query3REPTYPE: TStringField
      FieldName = 'REPTYPE'

      Size = 5
    end
    object Query3PARTCOST: TFloatField
      FieldName = 'PARTCOST'

    end
    object Query3OILCOST: TFloatField
      FieldName = 'OILCOST'

    end
    object Query3SUM1: TFloatField
      FieldName = 'SUM1'

    end
    object Query3LOCAT: TStringField
      FieldName = 'LOCAT'

      Size = 5
    end
    object Query3STRNO: TStringField
      FieldName = 'STRNO'

    end
    object Query3REGNO: TStringField
      FieldName = 'REGNO'

      Size = 15
    end
    object Query3REPCOD: TStringField
      FieldName = 'REPCOD'

      Size = 5
    end
    object Query3RECVCOD: TStringField
      FieldName = 'RECVCOD'

      Size = 5
    end
    object Query3PTAXNO: TStringField
      FieldName = 'PTAXNO'
  ...
  object QCoscolr: TFDQuery
    ConnectionName = 'HI_DBMS'
    MasterSource = DataSource1
    Left = 75
    Top = 36
  end
  object QCosOut: TFDQuery
    ConnectionName = 'HI_DBMS'
    MasterSource = DataSource1
    SQL.Strings = (
      'select jobno,sum(Netpric) as oserv from othtran where '
