object FmSTRpA11_1: TFmSTRpA11_1
  Left = 13
  Top = 35
  Width = 1267
  Height = 704
  ...
  object QueryA11: TFDQuery
    ...
    SQL.Strings = (
      'SELECT A.INVLOC,A.PARTNO,A.INVNO,A.INVDATE,A.CUSCOD,'
        ...
        '(C.SNAM||C.NAME1||C.NAME2) AS FULLNAME,'#39#39' AS JOBNO,B.PKNO,A.QTYO' +
        'UT,'
      'A.UPRICE,A.REDU1,A.TOTPRC FROM IC_TRANS A,IC_INVOI B '
      
        'WHERE B.CUSCOD=C.CUSCOD AND A.INVNO=B.INVNO  AND A.INVLOC=:LOCAT' +
        ' AND A.PARTNO=:PARTNO'
      '     UNION '
        ...
        '  (C.SNAM||C.NAME1||C.NAME2) AS FULLNAME,A.JOBNO,A.PKNO,A.QTY AS' +
        ' QTYOUT,A.UPRICE,   '
      
        '  A.REDU1,A.TOTPRC FROM PARTTRAN A,JOBORDER B,ARMAST C WHERE  B.' +
        'CUSCOD=C.CUSCOD AND          '
