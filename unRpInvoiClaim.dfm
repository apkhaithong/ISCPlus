object FRpInvoiClaim: TFRpInvoiClaim
  Left = 437
  Top = 253
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3634#3618#3591#3634#3609#3629#3629#3585#3651#3610#3626#3656#3591#3626#3636#3609#3588#3657#3634#3648#3588#3621#3617#3605#3633#3657#3591#3627#3609#3637#3657
  ClientHeight = 273
  ClientWidth = 453
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object RadioGroup1: TAdvOfficeRadioGroup
      ...
      ItemIndex = 0
      Items.Strings = (
        #3623#3633#3609#3607#3637#3656#3651#3610#3626#3656#3591
        #3648#3621#3586#3607#3637#3656#3651#3610#3626#3656#3591
        #3648#3621#3586#3607#3637#3656#3629#3609#3640#3617#3633#3605#3636)
      Ellipsis = False
    end
    object cxCheckBox1: TcxCheckBox
      Left = 59
      Top = 84
      Caption = #3619#3634#3618#3591#3634#3609#3648#3593#3614#3634#3632#3619#3634#3618#3585#3634#3619#3607#3637#3656#3617#3637#3618#3629#3604#3588#3657#3634#3591#3592#3656#3634#3618
      ParentFont = False
  ...
  object Query2: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT A.INVNO,A.INVDATE,A.CUSCOD,B.SNAM,B.NAME1,B.NAME2,A.CLAIM' +
        'AMT,A.PAYAMT,A.DIFAMT,A.SMPAY,A.CLAIMNO,'
      
        '       A.LOCAT,C.BILLNO,C.BILLDATE,C.VAT3,C.VAT3AMT,C.PAYMENT,A.' +
        'FLAG'
      '   FROM INVOICLAIM A'
    ...
    object Query2INVDATE: TDateField
      DisplayLabel = #3623#3633#3609#3607#3637#3656#3651#3610#3626#3656#3591
      FieldName = 'INVDATE'
    end
    ...
    object Query2SNAM: TStringField
      DisplayLabel = #3588#3635#3609#3635#3627#3609#3657#3634#3594#3639#3656#3629
      FieldName = 'SNAM'
      FixedChar = True
      Size = 8
    end
    ...
    object Query2CLAIMAMT: TFloatField
      DisplayLabel = #3618#3629#3604#3605#3633#3657#3591#3648#3588#3621#3617
      FieldName = 'CLAIMAMT'
      DisplayFormat = '##,##0.00'
    end
    object Query2PAYAMT: TFloatField
      DisplayLabel = #3618#3629#3604#3629#3609#3640#3617#3633#3605#3636
      FieldName = 'PAYAMT'
      DisplayFormat = '##,##0.00'
    end
    object Query2DIFAMT: TFloatField
      DisplayLabel = #3612#3621#3605#3656#3634#3591
      FieldName = 'DIFAMT'
      DisplayFormat = '##,##0.00'
    end
    object Query2SMPAY: TFloatField
      DisplayLabel = #3618#3629#3604#3594#3635#3619#3632
      FieldName = 'SMPAY'
      DisplayFormat = '##,##0.00'
    end
    object Query2CLAIMNO: TStringField
      DisplayLabel = #3648#3621#3586#3607#3637#3656#3629#3609#3640#3617#3633#3605#3636
      FieldName = 'CLAIMNO'
      FixedChar = True
      Size = 15
    end
    object Query2BILLNO: TStringField
      DisplayLabel = #3648#3621#3586#3607#3637#3656#3651#3610#3648#3626#3619#3655#3592
      FieldName = 'BILLNO'
      FixedChar = True
      Size = 12
    end
    object Query2BILLDATE: TDateField
      DisplayLabel = #3623#3633#3609#3607#3637#3656#3651#3610#3648#3626#3619#3655#3592
      FieldName = 'BILLDATE'
    end
    object Query2VAT3: TFloatField
      DisplayLabel = '%'#3627#3633#3585' '#3603' '#3607#3637#3656#3592#3656#3634#3618
      FieldName = 'VAT3'
      DisplayFormat = '##,##0.00'
    end
    object Query2VAT3AMT: TFloatField
      DisplayLabel = #3618#3629#3604#3627#3633#3585' '#3603' '#3607#3637#3656#3592#3656#3634#3618
      FieldName = 'VAT3AMT'
      DisplayFormat = '##,##0.00'
    end
    object Query2PAYMENT: TFloatField
      DisplayLabel = #3618#3629#3604#3626#3640#3607#3608#3636
      FieldName = 'PAYMENT'
      DisplayFormat = '##,##0.00'
    end
