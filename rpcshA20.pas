...
uses
  ...
  Buttons, StdCtrls, ExtCtrls, Db, QuickRpt, printers, qrprntr, ComCtrls,
  ToolWin, ImgList, Mask, AdvGlowButton, RzSpnEdt, cxButtonEdit, cxControls,
  cxContainer, cxEdit, cxTextEdit, cxMaskEdit, cxDropDownEdit, cxCalendar,
  AdvGroupBox, AdvOfficeButtons, AdvToolBar, cxGraphics, AdvPanel,
...
procedure TFRcsh_ac.FormCreate(Sender: TObject);
begin
  SFMain.Check_right('HDREP', 'HDREP01_2_4');
end;

procedure TFRcsh_ac.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := Cafree;
  FRcsh_ac := nil;
end;

procedure TFRcsh_ac.FormShow(Sender: TObject);
begin
  Edit2.SetFocus;
...
procedure TFRcsh_ac.frxReport1GetValue(const VarName: string;
  var Value: Variant);
var
  TK, XSORT: string;
begin
...
procedure TFRcsh_ac.Edit1PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
...
procedure TFRcsh_ac.Edit2PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  Application.CreateForm(TSearchSet, SearchSet);
...
procedure TFRcsh_ac.Edit10PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  Application.CreateForm(TSearchSet, SearchSet);
  if SearchSet.ShowModalPayDue = MrOk then
    Edit10.text := SearchSet.Keyno;
end;

procedure TFRcsh_ac.Edit5PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  Application.CreateForm(TSearchSet, SearchSet);
...
procedure TFRcsh_ac.Edit6PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  Application.CreateForm(TSearchSet, SearchSet);
...
procedure TFRcsh_ac.Edit7PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  Application.CreateForm(TSearchSet, SearchSet);
...
procedure TFRcsh_ac.Edit9PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  Application.CreateForm(TSearchSet, SearchSet);
...
procedure TFRcsh_ac.Edit8PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  Application.CreateForm(TSearchSet, SearchSet);
...
procedure TFRcsh_ac.CloseBtnClick(Sender: TObject);
begin
  self.Close;
end;

procedure TFRcsh_ac.DesignBtnClick(Sender: TObject);
begin
  DM_SEC.Do_Prev_Edit_FastReport(frxReport1,'fr_SaleArCredForAc.fr3','2'); {2 = Design Report}
end;

procedure TFRcsh_ac.PrevBtnClick(Sender: TObject);
begin
  DM_SEC.Do_Prev_Edit_FastReport(frxReport1,'fr_SaleArCredForAc.fr3','1'); {1 = Preview Report}
end;

procedure TFRcsh_ac.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if (Key = #13) then
  begin
