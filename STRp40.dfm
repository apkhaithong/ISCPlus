object FmSTRp40: TFmSTRp40
  Left = 557
  Top = 223
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3634#3618#3591#3634#3609#3626#3605#3655#3629#3585#3585#3634#3619#3660#3604
  ClientHeight = 309
  ClientWidth = 483
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object SortRadio: TAdvOfficeRadioGroup
      ...
      ItemIndex = 2
      Items.Strings = (
        #3619#3634#3618#3591#3634#3609#3626#3619#3640#3611#3618#3629#3604#3619#3623#3617'('#3619#3627#3633#3626#3626#3636#3609#3588#3657#3634')'
        #3619#3634#3618#3591#3634#3609#3626#3619#3640#3611#3618#3629#3604#3619#3623#3617'('#3585#3621#3640#3656#3617#3626#3636#3609#3588#3657#3634')'
        #3619#3634#3618#3591#3634#3609#3605#3634#3617#3648#3588#3621#3639#3656#3629#3609#3652#3627#3623#3651#3609#3588#3621#3633#3591)
      Ellipsis = False
    end
  ...
  object qrAccglmst: TFDQuery
    ...
    SQL.Strings = (
      'SELECT 1 GLTYPE,XSORT,ID_NO,LOCAT,DOCNO,DOCDT,PARTNO,PARTDESC,'
      '       CASE WHEN ID_NO = 1 THEN QTY ELSE 0 END QTYIN,'
      '       CASE WHEN ID_NO = 2 THEN QTY ELSE 0 END QTYOUT,'
      '       DESCRIPTION,UNIT'
      'FROM VIEW_STKCARD_MAYO '
      'ORDER BY LOCAT,PARTNO,DOCDT,XSORT ')
    Left = 224
    Top = 29
    object qrAccglmstGLTYPE: TIntegerField
      FieldName = 'GLTYPE'
    end
    object qrAccglmstXSORT: TIntegerField
      FieldName = 'XSORT'
    end
    object qrAccglmstID_NO: TIntegerField
      FieldName = 'ID_NO'
    end
    ...
    object qrAccglmstDOCNO: TStringField
      FieldName = 'DOCNO'
      FixedChar = True
      Size = 12
    end
    object qrAccglmstDOCDT: TDateField
      FieldName = 'DOCDT'
    end
    ...
    object qrAccglmstPARTDESC: TStringField
      FieldName = 'PARTDESC'
      FixedChar = True
      Size = 50
    end
    ...
    object qrAccglmstDESCRIPTION: TStringField
