   ...
   repeat
     ...
     begin
       ...
       begin
         ...
         begin
           DM_SEC.HI_DBMS.DriverName := PasswordDlg.DNAME.Text;
           ...
           DM_SEC.HI_DBMS.Params.Add('BLOBS TO CACHE=12000');
           DM_SEC.HI_DBMS.Params.Add('BLOB SIZE=12000');
       ...
       begin
         ...
         DM_SEC.HI_DBMS.Params.Add('DATABASE NAME='+PasswordDlg.EdDbms.Text);
         DM_SEC.HI_DBMS.Params.Add('USER NAME='+PasswordDlg.XAlias.EditValue);
         DM_SEC.HI_DBMS.Params.Add('ODBC DSN='+PasswordDlg.ODBC.Text);
         DM_SEC.HI_DBMS.Params.Add('BLOBS TO CACHE=20000');
         DM_SEC.HI_DBMS.Params.Add('BLOB SIZE=20000');         
         DM_SEC.HI_DBMS.Params.Add('PASSWORD='+PasswordDlg.PassDB.Text);
       end;
...
var
 ...
 begin
  ...
  Application.Title := '.::Dealer Management Solutions::.';
