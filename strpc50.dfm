object StRp_C50: TStRp_C50
  Left = 423
  Top = 51
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3634#3618#3591#3634#3609#3605#3657#3609#3607#3640#3609#3626#3636#3609#3588#3657#3634
  ClientHeight = 339
  ClientWidth = 466
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object RadioGroup2: TAdvOfficeRadioGroup
      ...
      Items.Strings = (
        ...
        #3651#3610#3648#3610#3636#3585)
      Ellipsis = False
    end
    object OptRadio: TAdvOfficeRadioGroup
      Left = 74
      Top = 146
      Width = 325
      Height = 61
      ...
      Items.Strings = (
        ...
        #3619#3633#3610#3588#3639#3609#3592#3634#3585#3621#3641#3585#3588#3657#3634
        #3611#3619#3633#3610#3611#3619#3640#3591#3618#3629#3604)
      Ellipsis = False
    end
    object CheckBox1: TcxCheckBox
      Left = 276
      Top = 67
      Caption = #3648#3593#3614#3634#3632#3619#3634#3618#3585#3634#3619#3649#3606#3617#3615#3619#3637
      ParentFont = False
  ...
  object qrExportStk: TFDQuery
    ...
    object qrExportStkQTYOUT: TFloatField
      DisplayLabel = #3592#3635#3609#3623#3609
      FieldName = 'QTYOUT'
      DisplayFormat = '##,##0'
    end
    object qrExportStkVATTYPE: TStringField
      DisplayLabel = #3611#3619#3632#3648#3616#3607#3616#3634#3625#3637
      FieldName = 'VATTYPE'
      Size = 1
    end
    object qrExportStkVATRT: TFloatField
    ...
    object qrExportStkFREE: TStringField
      DisplayLabel = #3615#3619#3637
      FieldName = 'FREE'
      Size = 1
    end
    ...
    object qrExportStkTYPESALE: TStringField
      DisplayLabel = #3611#3619#3632#3648#3616#3607#3591#3634#3609#3586#3634#3618
      FieldName = 'TYPESALE'
      Size = 2
    end
  end
