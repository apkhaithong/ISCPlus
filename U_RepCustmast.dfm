object URepCustmast: TURepCustmast
  Left = 495
  Top = 413
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3634#3618#3591#3634#3609#3611#3619#3632#3623#3633#3605#3636#3621#3641#3585#3588#3657#3634
  ClientHeight = 231
  ClientWidth = 502
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object edAump: TcxButtonEdit
      ...
      Properties.ClickKey = 112
      Properties.OnButtonClick = edAumpPropertiesButtonClick
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
      Style.Font.Name = 'Tahoma'
    ...
    object edProv: TcxButtonEdit
      ...
      Properties.ClickKey = 112
      Properties.OnButtonClick = edProvPropertiesButtonClick
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
      Style.Font.Name = 'Tahoma'
  ...
  object qrCustomer: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT A.CUSCOD,A.SNAM,A.NAME1,A.NAME2,A.ADDR1,A.ADDR2,A.TUMB,A.' +
        'AUMPDES,A.PROVDES,A.ZIP,A.TELP,'
      
        '                 B.TYPE,B.MDLCOD,B.COLOR,B.CC, B.STRNO,B.ENGNO,B' +
        '.REGNO'
      '  FROM VIEW_CUST A,SVMAST B  '
      ' WHERE A.CUSCOD=B.CUSCOD')
    Left = 348
    Top = 6
    object qrCustomerTYPE: TStringField
      DisplayLabel = #3618#3637#3656#3627#3657#3629
      FieldName = 'TYPE'
      FixedChar = True
      Size = 12
    end
    object qrCustomerMDLCOD: TStringField
      DisplayLabel = #3619#3640#3656#3609
      FieldName = 'MDLCOD'
      FixedChar = True
    end
    object qrCustomerCOLOR: TStringField
      DisplayLabel = #3626#3637
      FieldName = 'COLOR'
      FixedChar = True
    end
    object qrCustomerCC: TStringField
      DisplayLabel = #3586#3609#3634#3604
      FieldName = 'CC'
      FixedChar = True
      Size = 6
    end
    object qrCustomerSTRNO: TStringField
      DisplayLabel = #3648#3621#3586#3606#3633#3591
      FieldName = 'STRNO'
      FixedChar = True
    end
    object qrCustomerENGNO: TStringField
      DisplayLabel = #3648#3621#3586#3648#3588#3619#3639#3656#3629#3591
      FieldName = 'ENGNO'
      FixedChar = True
    end
    object qrCustomerREGNO: TStringField
      DisplayLabel = #3648#3621#3586#3607#3632#3648#3610#3637#3618#3609
      FieldName = 'REGNO'
      FixedChar = True
      Size = 15
    end
    object qrCustomerCUSCOD: TStringField
      DisplayLabel = #3619#3627#3633#3626#3621#3641#3585#3588#3657#3634
      FieldName = 'CUSCOD'
      FixedChar = True
      Size = 12
    end
    object qrCustomerSNAM: TStringField
      DisplayLabel = #3588#3635#3609#3635#3594#3639#3656#3629
      FieldName = 'SNAM'
      FixedChar = True
      Size = 8
    end
    object qrCustomerNAME1: TStringField
      DisplayLabel = #3594#3639#3656#3629
      FieldName = 'NAME1'
      FixedChar = True
      Size = 50
    end
    object qrCustomerNAME2: TStringField
      DisplayLabel = #3626#3585#3640#3621
      FieldName = 'NAME2'
      FixedChar = True
      Size = 50
    end
    object qrCustomerADDR1: TStringField
      DisplayLabel = #3607#3637#3656#3629#3618#3641#3656
      FieldName = 'ADDR1'
      FixedChar = True
      Size = 60
    end
    object qrCustomerADDR2: TStringField
      DisplayLabel = #3607#3637#3656#3629#3618#3641#3656
      FieldName = 'ADDR2'
      FixedChar = True
      Size = 60
    end
    object qrCustomerTUMB: TStringField
      DisplayLabel = #3605#3635#3610#3610
      FieldName = 'TUMB'
      FixedChar = True
      Size = 60
    end
    object qrCustomerZIP: TStringField
      DisplayLabel = #3619#3627#3633#3626#3652#3611#3619#3625#3603#3637#3618#3660
      FieldName = 'ZIP'
      FixedChar = True
      Size = 8
    end
    object qrCustomerTELP: TStringField
      DisplayLabel = #3650#3607#3619#3624#3633#3614#3607#3660
      FieldName = 'TELP'
      FixedChar = True
    end
    object qrCustomerAUMPDES: TStringField
      FieldName = 'AUMPDES'
      FixedChar = True
      Size = 60
    end
    object qrCustomerPROVDES: TStringField
      FieldName = 'PROVDES'
      FixedChar = True
      Size = 60
    end
  ...
  object qrExportStk: TFDQuery
    ...
    ConnectionName = 'Hi_dbms'
    SQL.Strings = (
      'SELECT A.GCODE,A.DESCP,J.CUSCOD,B.SNAM,B.NAME1,B.NAME2,B.GRPCUS,'
      
        '       B.ADDRES,B.TUMB,B.AUMPCOD,B.AUMPDES,B.PROVCOD,B.PROVDES,B' +
        '.ZIP,B.TELP'
      '       FROM JOBORDER J,VIEW_CUST B,SERVTRAN T,GRPORDMAIN A'
      
        '       WHERE (J.CUSCOD=B.CUSCOD) AND (J.JOBNO=T.JOBNO) AND (T.CO' +
        'DE=A.SVCODE) '
      '       AND (B.GRPCUS LIKE '#39'%'#39')'
      '        AND (A.GCODE LIKE '#39'%'#39')'
      
        'GROUP BY A.GCODE,A.DESCP,J.CUSCOD,B.SNAM,B.NAME1,B.NAME2,B.GRPCU' +
        'S,'
      
        '       B.ADDRES,B.TUMB,B.AUMPCOD,B.AUMPDES,B.PROVCOD,B.PROVDES,B' +
        '.ZIP,B.TELP'
      'ORDER BY A.GCODE,J.CUSCOD')
    Left = 427
    Top = 44
    object qrExportStkGCODE: TStringField
      FieldName = 'GCODE'
      FixedChar = True
      Size = 10
    end
    object qrExportStkDESCP: TStringField
      FieldName = 'DESCP'
      FixedChar = True
      Size = 70
    end
    ...
    object qrExportStkGRPCUS: TStringField
      FieldName = 'GRPCUS'
      FixedChar = True
      Size = 5
    end
    object qrExportStkADDRES: TStringField
      FieldName = 'ADDRES'
      Size = 103
    end
    object qrExportStkTUMB: TStringField
      FieldName = 'TUMB'
      FixedChar = True
      Size = 40
    end
    object qrExportStkAUMPCOD: TStringField
      FieldName = 'AUMPCOD'
      FixedChar = True
      Size = 5
    end
    object qrExportStkAUMPDES: TStringField
      FieldName = 'AUMPDES'
      FixedChar = True
      Size = 60
    end
    object qrExportStkPROVCOD: TStringField
      FieldName = 'PROVCOD'
      FixedChar = True
      Size = 5
    end
    object qrExportStkPROVDES: TStringField
      FieldName = 'PROVDES'
      FixedChar = True
      Size = 60
    end
    object qrExportStkZIP: TStringField
      FieldName = 'ZIP'
      FixedChar = True
      Size = 8
    end
    object qrExportStkTELP: TStringField
      FieldName = 'TELP'
      FixedChar = True
      Size = 50
    end
