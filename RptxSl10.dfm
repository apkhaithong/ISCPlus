object FRptxSl10: TFRptxSl10
  Left = 437
  Top = 253
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3634#3618#3591#3634#3609#3616#3634#3625#3637#3586#3634#3618'-'#3619#3606
  ClientHeight = 331
  ClientWidth = 453
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object RadioGroup2: TAdvOfficeRadioGroup
      ...
      ItemIndex = 3
      Items.Strings = (
        #3616#3634#3625#3637#3648#3611#3636#3604#3585#3634#3619#3586#3634#3618
        #3616#3634#3625#3637#3648#3591#3636#3609#3592#3629#3591#3649#3621#3632#3629#3639#3656#3609#3654
        #3651#3610#3621#3604#3627#3609#3637#3657#3607#3633#3657#3591#3627#3617#3604
        #3616#3634#3625#3637#3607#3633#3657#3591#3627#3617#3604)
      Ellipsis = False
    end
    object RadioGroup1: TAdvOfficeRadioGroup
      ...
      Items.Strings = (
        ...
        #3648#3621#3586#3607#3638#3656#3626#3633#3597#3597#3634
        #3648#3621#3586#3607#3637#3656#3651#3610#3585#3635#3585#3633#3610
        #3623#3633#3609#3607#3637#3656#3610#3633#3609#3607#3638#3585)
      Ellipsis = False
    end
  ...
  object Query2: TFDQuery
    ConnectionName = 'HI_DBMS'
    SQL.Strings = (
      'SELECT TAXDT,TAXNO,SNAM,NAME1,NAME2,DESCP,'
      
        'NETAMT,VATAMT,TOTAMT,FLAG,STRNO,FINCOD,RTRIM(SNAM)||RTRIM(NAME1)' +
        '||'#39'   '#39'||RTRIM(NAME2) CUSTOMER'
      'FROM TAXTRAN')
    Left = 288
    Top = 128
    object Query2TAXDT: TDateField
    ...
    object Query2CUSTOMER: TStringField
      DisplayLabel = #3621#3641#3585#3588#3657#3634
      FieldName = 'CUSTOMER'
      Size = 115
    end
    ...
    object Query2DESCP: TStringField
    ...
    object Query2TOTAMT: TFloatField
      DisplayLabel = #3617#3641#3621#3588#3656#3634#3619#3623#3617
      FieldName = 'TOTAMT'
    end
    ...
    object Query2FINCOD: TStringField
      DisplayLabel = #3619#3627#3633#3626#3652#3615#3649#3609#3609#3595#3660
      FieldName = 'FINCOD'
      FixedChar = True
      Size = 8
    end
