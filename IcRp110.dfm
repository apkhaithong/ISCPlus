object FIcRp110: TFIcRp110
  ...
  object AdvPanel1: TAdvPanel
    ...
    object Label17: TLabel
      ...
      Height = 16
      Alignment = taRightJustify
      Caption = #3594#3633#3657#3609#3648#3585#3655#3610' :'
      Font.Charset = THAI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
    ...
    object Label18: TLabel
      ...
      Height = 16
      Alignment = taRightJustify
      Caption = #3619#3634#3588#3634#3586#3634#3618#3619#3632#3604#3633#3610' :'
      Font.Charset = THAI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
    ...
    object CheckBox2: TcxCheckBox
      Left = 33
      Top = 146
      Caption = #3652#3617#3656#3605#3657#3629#3591#3619#3634#3618#3591#3634#3609#3623#3633#3626#3604#3640#3626#3636#3657#3609#3648#3611#3621#3639#3629#3591
      ParentFont = False
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
    ...
    object CheckBox1: TcxCheckBox
      Left = 258
      Top = 146
      Caption = #3618#3585#3648#3623#3657#3609#3619#3634#3618#3585#3634#3619#3607#3637#3656' Onh=0,Allo=0'
      ParentFont = False
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
    ...
    object RadioGp5: TAdvOfficeRadioGroup
      Left = 1
      Top = 189
      Width = 481
      Height = 63
      Version = '1.6.1.0'
      Align = alBottom
      Caption = #3605#3657#3629#3591#3585#3634#3619#3619#3634#3618#3591#3634#3609#3648#3593#3614#3634#3632
      Font.Charset = THAI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
      ...
      ParentFont = False
      TabOrder = 12
      OnClick = RadioGp5Click
      Columns = 4
      ItemIndex = 0
      Items.Strings = (
        #3607#3633#3657#3591#3627#3617#3604
        #3626#3605#3655#3629#3585#3617#3634#3585#3585#3623#3656#3634' 0'
        #3626#3605#3655#3629#3585#3609#3657#3629#3618#3585#3623#3656#3634' 0'
        #3626#3605#3655#3629#3585#3648#3607#3656#3634#3585#3633#3610' 0'
        #3607#3637#3656#3617#3637#3626#3606#3634#3609#3607#3637#3656#3648#3585#3655#3610
        #3618#3629#3604' Onh<>Allo'
        #3605#3657#3609#3607#3640#3609#3609#3657#3629#3618#3585#3623#3656#3634' 0'
        #3626#3605#3655#3629#3585#3652#3617#3656#3648#3607#3656#3634#3585#3633#3610' 0')
      Ellipsis = False
    end
    object SortRadio: TAdvOfficeRadioGroup
      ...
      Items.Strings = (
        ...
        #3619#3627#3633#3626#3585#3621#3640#3656#3617#3626#3636#3609#3588#3657#3634
        #3619#3627#3633#3626#3619#3640#3656#3609#3626#3636#3609#3588#3657#3634
        #3607#3637#3656#3648#3585#3655#3610#3626#3636#3609#3588#3657#3634
        #3612#3641#3657#3592#3635#3627#3609#3656#3634#3618)
      Ellipsis = False
    end
  end
  ...
  object qrExportStk: TFDQuery
    ...
    SQL.Strings = (
        ...
        '                 t.price1 as onlo1,t.price1 As Prc1,t.cost,t.Std' +
        'buy As Tot1,Stdbuy as tot2,t.Shelf,'
      '                 t.max1,t.min1,t.movdate'
      'From Inventor t,Invanls a '
      'Where t.locat=a.locat and t.partno=a.partno'
    ...
    object qrExportStkMOVDATE: TDateField
      DisplayLabel = #3623#3633#3609#3607#3637#3656#3648#3586#3657#3634#3621#3656#3634#3626#3640#3604
      FieldName = 'MOVDATE'
    end
    object qrExportStkONLO1: TFloatField
      DisplayLabel = #3588#3591#3648#3627#3621#3639#3629
      FieldName = 'ONLO1'
    end
    object qrExportStkTOT2: TFloatField
      DisplayLabel = #3607#3640#3609#3619#3623#3617
      FieldName = 'TOT2'
    end
    object qrExportStkTYPE: TStringField
    ...
    object qrExportStkMAX1: TFloatField
      DisplayLabel = #3626#3605#3658#3629#3585#3626#3641#3591#3626#3640#3604
      FieldName = 'MAX1'
    end
    object qrExportStkCOST: TFloatField
      DisplayLabel = #3607#3640#3609#3605#3656#3629#3627#3609#3656#3623#3618
      FieldName = 'COST'
    end
    object qrExportStkMIN1: TFloatField
      DisplayLabel = #3626#3605#3655#3629#3585#3605#3656#3635#3626#3640#3604
      FieldName = 'MIN1'
    end
    object qrExportStkMODEL: TStringField
      DisplayLabel = #3619#3640#3656#3609
      FieldName = 'MODEL'
      FixedChar = True
    end
    ...
    object qrExportStkONHN1: TFloatField
      DisplayLabel = #3588#3591#3648#3627#3621#3639#3629'('#3610'/'#3594')'
      FieldName = 'ONHN1'
    end
    object qrExportStkTOT1: TFloatField
      DisplayLabel = #3592#3635#3609#3623#3609#3648#3591#3636#3609
      FieldName = 'TOT1'
    end
    object qrExportStkPRC1: TFloatField
      DisplayLabel = #3619#3634#3588#3634#3586#3634#3618
      FieldName = 'PRC1'
    end
    object qrExportStkSHELF: TStringField
      DisplayLabel = #3594#3633#3657#3609#3648#3585#3655#3610
      FieldName = 'SHELF'
      FixedChar = True
      Size = 15
    end
    object qrExportStkLOCAT: TStringField
