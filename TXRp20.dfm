object FmTXRp20: TFmTXRp20
  ...
  object qrTaxBuy: TFDQuery
    ...
    SQL.Strings = (
        ...
        'Select A.Locat,a.Taxno,a.Taxdate,a.cuscod,c.apname,a.Balance,a.v' +
        'atrt,a.Vat,a.Tottax,a.Desc1,a.flag,a.Cancel,a.Cancelid,a.aptype'
      '    from TaxBuy A,Apmast c'
      '    Where (a.Flag='#39'1'#39')  and a.cuscod=c.apcode'
      '    Union'
      ...
      '    from TaxBuy A,NRc_invoi B,Apmast c'
        ...
        'Where (a.taxrefno=b.Recvno) and (a.Flag='#39'3'#39')    and a.cuscod=c.a' +
        'pcode'
      '    Union'
        ...
        'atrt,a.Vat,a.Tottax,a.Desc1,a.flag,a.Cancel,a.Cancelid,a.aptype'
      '    from TaxBuy  a,Apmast c'
      ' Where a.Flag='#39'6'#39'   and a.cuscod=c.apcode'
      '')
    Left = 404
    Top = 14
    ...
    object qrTaxBuyAPNAME: TStringField
      DisplayLabel = #3594#3639#3656#3629#3648#3592#3657#3634#3627#3609#3637#3657
      FieldName = 'APNAME'
      FixedChar = True
      Size = 60
    end
    object qrTaxBuyBALANCE: TFloatField
      DisplayLabel = #3617#3641#3621#3588#3656#3634
      FieldName = 'BALANCE'
    end
    ...
    object qrTaxBuyTOTTAX: TFloatField
      DisplayLabel = #3619#3634#3588#3634#3619#3623#3617#3616#3634#3625#3637
      FieldName = 'TOTTAX'
    end
