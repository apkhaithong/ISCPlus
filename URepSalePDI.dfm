object FRepSalePDI: TFRepSalePDI
  Left = 388
  Top = 118
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3634#3618#3591#3634#3609#3605#3619#3623#3592#3626#3629#3610' PDI'
  ClientHeight = 213
  ClientWidth = 442
  Color = clBtnFace
  ...
  object Query2: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT IDNO, SDATE, MODEL, CUSCOD, STRNO, ENGNO, CUSTOMER, ADDR,' +
        ' RODE, TUMB, AUMPDES, PROVDES, ZIP, TELP'
      'FROM VIEW_EXP2EXL'
      'WHERE SDATE BETWEEN '#39'2014-03-01'#39' AND '#39'2014-03-31'#39
      'ORDER BY IDNO,SDATE')
    Left = 368
    Top = 56
    object Query2IDNO: TIntegerField
    ...
    object Query2ENGNO: TStringField
      DisplayLabel = #3648#3621#3586#3648#3588#3619#3639#3656#3629#3591#3618#3609#3605#3660
      FieldName = 'ENGNO'
      FixedChar = True
    end
    ...
    object Query2ADDR: TStringField
      DisplayLabel = #3607#3637#3656#3629#3618#3641#3656
      FieldName = 'ADDR'
      FixedChar = True
      Size = 60
    end
    object Query2RODE: TStringField
      DisplayLabel = #3606#3609#3609
      FieldName = 'RODE'
      FixedChar = True
      Size = 40
    end
