object SvRechk: TSvRechk
  Left = 332
  Top = 170
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = #3619#3634#3618#3591#3634#3609#3605#3636#3604#3605#3634#3617#3612#3621#3585#3634#3619#3651#3627#3657#3610#3619#3636#3585#3634#3619
  ClientHeight = 264
  ClientWidth = 461
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object cxCheckBox1: TcxCheckBox
      Left = 57
      Top = 243
      Caption = #3649#3626#3604#3591#3619#3634#3618#3585#3634#3619#3588#3635#3626#3633#3656#3591#3595#3656#3629#3617
      ParentFont = False
      State = cbsChecked
    ...
    object cxCheckBox2: TcxCheckBox
      Left = 57
      Top = 263
      Caption = #3649#3626#3604#3591#3619#3634#3618#3585#3634#3619#3629#3632#3652#3627#3621#3656
      ParentFont = False
      State = cbsChecked
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
    ...
    object cxCheckBox3: TcxCheckBox
      Left = 57
      Top = 284
      Caption = #3649#3626#3604#3591#3619#3634#3618#3585#3634#3619#3588#3656#3634#3649#3619#3591
      ParentFont = False
      State = cbsChecked
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
    ...
    object cxCheckBox4: TcxCheckBox
      Left = 257
      Top = 263
      Caption = #3649#3626#3604#3591' Memo '#3605#3629#3609#3648#3611#3636#3604' Job'
      ParentFont = False
      State = cbsChecked
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
    ...
    object cxCheckBox5: TcxCheckBox
      Left = 257
      Top = 243
      Caption = #3649#3626#3604#3591' Blank Line '#3610#3633#3609#3607#3638#3585#3612#3621
      ParentFont = False
      State = cbsChecked
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
    ...
    object JobDtOption: TAdvOfficeRadioGroup
      Left = 1
      Top = 96
      Width = 459
      Height = 50
      Version = '1.6.1.0'
      Align = alBottom
      Caption = #3648#3591#3639#3656#3629#3609#3652#3586#3623#3633#3609#3607#3637#3656
      Font.Charset = THAI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
      ...
      Items.Strings = (
        #3623#3633#3609#3607#3637#3656#3649#3592#3657#3591#3595#3656#3629#3617
        #3623#3633#3609#3607#3637#3656#3595#3656#3629#3617#3648#3626#3619#3655#3592
        #3623#3633#3609#3607#3637#3656#3626#3656#3591#3617#3629#3610)
      Ellipsis = False
    end
  end
  ...
  object Query2: TFDQuery
    ...
    SQL.Strings = (
        ...
        'Select J.JOBNO,J.Cuscod,c.custname,c.TELP,J.Recvdate,J.RFINSHDT,' +
        'J.PAYDATE,J.RLKILOMT,'
      'J.Strno,J.Reptype,J.App_Date,J.App_Mile,J.Mdlcod,B.REGNO,s.desc1'
      'From Joborder J left join svmast b on (j.strno=b.strno)'
      '                LEFT JOIN VIEW_CUST c ON (j.CUSCOD=c.CUSCOD) '
      '                LEFT JOIN SERVTRAN s ON (j.JOBNO=s.JOBNO)')
    Left = 320
    Top = 40
    ...
    object Query2RECVDATE: TDateField
      DisplayLabel = #3623#3633#3609#3607#3637#3656#3648#3586#3657#3634#3619#3633#3610#3610#3619#3636#3585#3634#3619
      FieldName = 'RECVDATE'
    end
    object Query2RFINSHDT: TDateField
      DisplayLabel = #3623#3633#3609#3607#3637#3656#3595#3656#3629#3617#3648#3626#3619#3655#3592
      FieldName = 'RFINSHDT'
    end
    object Query2PAYDATE: TDateField
      DisplayLabel = #3623#3633#3609#3607#3637#3656#3626#3656#3591#3617#3629#3610
      FieldName = 'PAYDATE'
    end
    object Query2RLKILOMT: TFloatField
      DisplayLabel = #3648#3621#3586' '#3585#3617'.'
      FieldName = 'RLKILOMT'
    end
    object Query2STRNO: TStringField
      DisplayLabel = #3627#3617#3634#3618#3648#3621#3586#3605#3633#3623#3606#3633#3591
      FieldName = 'STRNO'
      FixedChar = True
    end
    ...
    object Query2CUSTNAME: TStringField
      DisplayLabel = #3619#3634#3618#3621#3632#3648#3629#3637#3618#3604#3621#3641#3585#3588#3657#3634
      FieldName = 'CUSTNAME'
      Size = 111
    end
    object Query2TELP: TStringField
    ...
    object Query2APP_DATE: TDateField
      DisplayLabel = #3623#3633#3609#3607#3637#3656#3609#3633#3604#3588#3619#3633#3657#3591#3606#3633#3604#3652#3611
      FieldName = 'APP_DATE'
    end
    object Query2APP_MILE: TFloatField
      DisplayLabel = #3585#3617'.'#3607#3637#3656#3609#3633#3604#3588#3619#3633#3657#3591#3606#3633#3604#3652#3611
      FieldName = 'APP_MILE'
    end
    object Query2DESC1: TStringField
      DisplayLabel = #3591#3634#3609#3607#3637#3656#3607#3635
      FieldName = 'DESC1'
      FixedChar = True
      Size = 70
    end
