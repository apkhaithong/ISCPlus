object FAnlrp40: TFAnlrp40
  ...
  object AdvPanel1: TAdvPanel
    ...
    object CheckBox1: TcxCheckBox
      Left = 221
      Top = 29
      Caption = #3619#3623#3617#3619#3634#3618#3585#3634#3619#3651#3610#3621#3604#3627#3609#3637#3657#3604#3657#3623#3618
      ParentFont = False
      Style.Font.Charset = THAI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
    ...
    object RadioGroup1: TAdvOfficeRadioGroup
      ...
      Height = 90
      Version = '1.6.1.0'
      Caption = #3648#3621#3639#3629#3585#3619#3634#3618#3591#3634#3609#3648#3593#3614#3634#3632
      Font.Charset = THAI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'Tahoma'
      ...
      ItemIndex = 2
      Items.Strings = (
        #3586#3634#3618#3627#3609#3657#3634#3619#3657#3634#3609' IC'
        #3621#3604#3627#3609#3637#3657#3626#3636#3609#3588#3657#3634' CI'
  ...
  object Query2: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT A.LOCAT,A.TAXNO,A.CUSCOD,RTRIM(SNAM)||RTRIM(NAME1)||'#39'   '#39 +
        '||RTRIM(NAME2) CUSTOMER,A.JOBNO,A.TAXDATE,A.BALANCE,'
      
        '                     A.VAT,A.TOTTAX,A.PAYTYP,A.CANCELID,A.FLAG,A' +
        '.CREDIT,A.CASH,'
      
        '                     A.DATAFRM,A.PARTTOT,A.SERVTOT,A.OTHTOT,A.PA' +
        'RT_ONLY,B.SNAM,B.NAME1,B.NAME2'
      '                      FROM VIEW_ACCOUNT A,CUSTMAST B'
      
        '                      WHERE (A.TAXDATE>='#39'2014-09-01'#39' AND A.TAXDA' +
        'TE<='#39'2014-09-30'#39') AND A.LOCAT LIKE '#39'%'#39' AND'
      
        '                      A.CUSCOD=B.CUSCOD AND BALANCE>0 AND A.CANC' +
        'ELID IS NULL ORDER BY A.LOCAT,A.TAXNO')
    Left = 224
    Top = 136
    ...
    object Query2CUSTOMER: TStringField
      DisplayLabel = #3594#3639#3656#3629'-'#3626#3585#3640#3621#3621#3641#3585#3588#3657#3634
      FieldName = 'CUSTOMER'
      Size = 111
    end
